...
def init(base):
    ...
    # parser.add_argument("s1", type=int, nargs='?', const=100000, default=100000)
    # parser.add_argument("s2", type=int, nargs='?', const=5000, default=5000)
    # parser.add_argument("s3", type=int, nargs='?', const=150, default=150)
    # parser.add_argument("s4", type=int, nargs='?', const=150, default=150)
    ...
    def find_move(data_arr, fingers_arr):
        ...
        if len(one) - list([a_i - b_i for a_i, b_i in
            ...
            [a_i - b_i for a_i, b_i in
             zip(two, sorted(two, reverse=True))]).count(
            0) < 3:
            if one and two:
